...
class _ChallanListState extends State<ChallanList> {
  ...
  Future<void> fetchChallanList() async {
    ...
    try {
      ...
      final response = await dio.post(
        NetworkConfig.baseUrl + NetworkConfig.list_trip_challan,
        data: {},
      );
  ...
  Future<void> deleteChallan(String tripId) async {
    ...
    try {
      final dio = Dio();
      final response = await dio.post(
        NetworkConfig.baseUrl + NetworkConfig.deleteChallan +'?tripid=$tripId',
        data: {
  ...
  Future<void> submitFilter() async {
    ...
    try {
      ...
      final response = await dio.post(
        NetworkConfig.baseUrl + NetworkConfig.filterChallan,
          ...
          topWidget: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('Challan List',style: TextStyle(fontWeight: FontWeight.w600,color: Colors.white,fontSize: 20),),
                SizedBox()
              ],
            ),
          ))
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            InkWell(
                                onTap: (){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>CreateChallan(callback: (){
                                    Navigator.pop(context);
                                    fetchChallanList();
                                ...
                                onTap: ()async{
                                  ...
                                  if(data['trip_id'] != null) {
                                    final Uri url = Uri.parse(
                                        'https://www.artistonecrusher.com/index/print_challan/${data['trip_id']}');
                    ...
                    const SizedBox(height: 4),
                    Text('Challan No: ${data['challan_no']??''}', style:  TextStyle(fontWeight: FontWeight.bold,color: K.darkOrange)),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 2,),
                        Expanded(child: Text(' ${data['company_name']??''} ')),
                      ],
                    ),
                    Row(
                      children: [
                        ...
                        SizedBox(width: 2,),
                        Text('Company: ${data['challan_company_name']??''}'),
                      ],
                    ),
                    Row(
                      children: [
